    ...
    <div class="row mb-4">
        <div class="col-12">
            <h1 class="h3 mb-0 text-white">
                <i class="fas fa-school me-2"></i>Modifier École: {{ $ecole->nom }}
            </h1>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-8 mx-auto">
            <div class="glass-card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.ecoles.update', $ecole) }}" class="needs-validation" novalidate>
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('statut') is-invalid @enderror" 
                                        ...
                                        name="statut" 
                                        required>
                                    <option value="active" {{ old('statut', $ecole->statut) == 'active' ? 'selected' : '' }}>Active</option>
                                    <option value="inactive" {{ old('statut', $ecole->statut) == 'inactive' ? 'selected' : '' }}>Inactive</option>
                                </select>
                                @error('statut')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="{{ route('admin.ecoles.show', $ecole) }}" class="btn btn-secondary">
