...
<div class="page-transition">
    ...
    <div class="dashboard-section mb-3">
        <div class="alert alert-info">
            ...
            Vous gérez : <strong>{{ auth()->user()->ecole->nom ?? 'École de Karaté' }}</strong>
        </div>
    </div>
    ...
    <div class="metrics-grid">
        ...
        <div class="metric-card">
            <div class="metric-card-content">
                ...
                <div class="metric-details">
                    <div class="metric-number">{{ $stats['membres'] ?? 0 }}</div>
        ...
        <div class="metric-card">
            <div class="metric-card-content">
                ...
                <div class="metric-details">
                    <div class="metric-number">{{ $stats['cours'] ?? 0 }}</div>
        ...
        <div class="quick-actions-grid">
            ...
            <a href="{{ route('admin.membres.index') }}" class="quick-action-card">
                ...
                <div class="quick-action-content">
                    ...
                    <div class="quick-action-stats">
                        <span class="badge badge-success">{{ $stats['membres'] ?? 0 }} membres</span>
                    </div>
                </div>
            ...
            <a href="{{ route('admin.cours.index') }}" class="quick-action-card">
                ...
                <div class="quick-action-content">
                    ...
                    <div class="quick-action-stats">
                        <span class="badge badge-primary">{{ $stats['cours'] ?? 0 }} cours</span>
                    </div>
                </div>
                <div class="quick-action-arrow">
                    <i class="fas fa-chevron-right"></i>
